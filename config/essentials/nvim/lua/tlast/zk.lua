...
vim.keymap.set({"n", "i"}, "<LocalLeader>i", "<CMD>lua require('telekasten').insert_link()<CR>")
vim.keymap.set({"n", "i"}, "<LocalLeader>I", "<CMD>lua require('telekasten').insert_img_link<CR>")
vim.keymap.set({"n", "i"}, "<LocalLeader>t", "<CMD>lua require('telekasten').toggle_todo<CR>")
