...
vim.keymap.set("n", "<leader>zi", require('telekasten').insert_link)
...
vim.keymap.set("i", "<LocalLeader>I", require('telekasten').insert_img_link)
vim.keymap.set("i", "<LocalLeader>t", require('telekasten').toggle_todo)
