...
alias edw='vi ~/proj/dwm/config.def.h'
alias edm='vi ~/proj/dmenu/config.def.h'
alias ehst='vi $ZDOTDIR/histfile'
alias ezh=' vi $HISTFILE'
alias est='vi ~/proj/st/config.def.h'
alias esl='vi ~/proj/slock/config.def.h'
alias esls='vi ~/proj/slstatus/config.def.h'
...
alias cddm='cd ~/proj/dmenu'
alias cdw='cd ~/proj/dwm'
alias cdslo='cd ~/proj/slock'
alias cdsl='cd ~/proj/slstatus'
alias cdst='cd ~/proj/st'
alias cdsta='cd ~/proj/stable-diffusion-webui'
alias cdsu='cd ~/proj/surf'
alias cds='cd ~/src/'
